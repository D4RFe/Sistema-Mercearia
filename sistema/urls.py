...
from .views import homepage, Vendas, relatorios, Estoque, caixa, RelatorioDeVendas, RelatorioDeCaixa, cadastrarProduto, EditarProduto, clientes, fornecedores, entradaDeNotas, salvar_entrada, RelatorioDeFornecedor
...
urlpatterns = [
    ...
    path('relatoriofornecedor/<int:pk>', RelatorioDeFornecedor.as_view(), name="relatoriofornecedor"),
